...
public class Scenario2_2 extends BaseTest {
    ...
    @Test(priority = 10, testName = "10\tClose the dialog Paymen to back to the Cart")
    public void step10() {
        System.out.println("-------------------- 10\tClose the dialog Paymen to back to the Cart");
    ...
    public void step122() {
        customer = new Customer();
        System.out.println("-------------------- 8\tUse customer point to get discount");
        dashboardPage.subTotalStr = subTotalAmount;
        SoftAssert softAssert = new SoftAssert();
        String subtotal = subTotalAmount;
        String expTotalAmount = createOrderPage.totalAmount(subtotal, customerDataTest.CUSTOMER_PHONE);
        helper.sleep(1);
    ...
    @Test(priority = 14, testName = "14\tPay the order by Bank Transfer")
    public void step14() {
        System.out.println("-------------------- 14\tPay the order by Bank Transfer");
    ...
    public void step17() {
        ...
        System.out.println(promotionTotalAmount);
        //order detail
        ...
        posappHelper.writeBillOrderFile("2_2_" + posappHelper.FILE_PATH, dashboardPage.productCartList, customer, paymentDataTest.PAYMENT_BY_CASH, subTotalAmount, String.valueOf(dashboardPage.quantityCartTotal), helper.formatCurrencyToThousand(promotionTotalAmount), totalAmount);
        helper.sleep(1);
