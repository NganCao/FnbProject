package com.fnb.app.storeapp.android.linstore.scenationtests.register.registerlink;
...
//        assertEquals(loginPageLinStore.verifyToastMessDisplay(), LOGIN_SUCCESS_ALERT, "Testcase 8475 register is Fail, Toast message is not match");
    ...
    public void verifyFU8480() {
        ...
        registerPageLinStore.verifyInvalidEmail("1");
    ...
    public void verifyFU8482() {
        ...
        softAssert.assertEquals(registerPageLinStore.verifyAlertInvalidEmail(), LOGIN_FAIL_ALERT, "Verify the failure message when input valid name, password but wrong format is Fail, Alert is not match");
    }
...
//    @Test(priority = 24)
//    public void verifyUI8356R() {
//        Log.info("Running verify UI Register Title");
//        softAssert.assertTrue(registerPageLinStore.checkDisplayRegisterText(), "Verify testcase 8356 is fail - Register Account title is not display");
//    }
