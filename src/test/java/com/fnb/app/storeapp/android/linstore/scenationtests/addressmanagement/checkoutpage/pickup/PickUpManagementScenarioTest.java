package com.fnb.app.storeapp.android.linstore.scenationtests.addressmanagement.checkoutpage.pickup;
...
import static com.fnb.app.storeapp.android.linstore.pages.addressmanagement.pickup.PickUpManagementDataTest.PICKUP_TYPE;
...
public class PickUpManagementScenarioTest extends BaseTest {
    ...
    public void verifyIconPickUp() {
        ...
        Assert.assertTrue(pickUpManagementPage.checkDisplayChangeOrderType());
    ...
    public void verifyPickUpAddressText() {
        ...
        Assert.assertTrue(pickUpManagementPage.checkDisplayPickUpAddressText(), "Test case fail");
        Assert.assertEquals(s, s1, "test case is fail 2");
    ...
    public void verifyCheckDeliveryType() {
        pickUpManagementPage.clickClosedIcon();
        ...
        Assert.assertEquals(deliveryType, PICKUP_TYPE, "Testcase is fail");
    }

    @Test(priority = 58)
    public void verifyCheckCurrentBranchName() {
        Assert.assertTrue(pickUpManagementPage.checkDisplayBranchNameText(), "Testcase is fail");
        storeName = pickUpManagementPage.getTextBranchNameText();
        Assert.assertEquals(storeName, pickUpManagementPage.checkApiGetBranchInfo(storeName, "storeName", addressUser));
    }

    @Test(priority = 59)
    public void verifyCheckCurrentBranchAddress() {
        Assert.assertTrue(pickUpManagementPage.checkDisplayLocationAddressText(), "Test case fail");
        String address = pickUpManagementPage.getTextLocationAddressText();
        Assert.assertEquals(address, pickUpManagementPage.checkApiGetBranchInfo(storeName, "address", addressUser));
    }
}
