package com.fnb.app.storeapp.android.linstore.scenationtests.addressmanagement.homepage.delivery.addnewaddress;
...
//        addressManagementListPage.clickDeliveryHeader();
        addressManagementListPage.navigateBack();
        addressManagementListPage.clickDeliveryField();
        addNewAddressPage.clickDeleteHomeAddress();
        addNewAddressPage.clickDeleteWorkAddress();
        addNewAddressPage.clickDeleteOtherAddress();
    ...
    public void verifySearchResultMatchAddress1() {
        softAssert.assertTrue(addNewAddressPage.checkDisplaySearchResultMatchAddress1(), "Testcase is fail");
        softAssert.assertEquals(addNewAddressPage.getTextSearchResultMatchAddress1(), ADDRESS_SEARCH_1, "Testcase is fail");
    ...
    public void verifyAddHomeNewAddress() {
        ...
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_0, "Testcase is fail");
    ...
    public void verifyAddHomeNewAddressWithDetail() {
        ...
        softAssert.assertEquals(actualAddress, expectedAddress, "Testcase is fail");
        softAssert.assertEquals(ADDRESS_DETAIL, expectedAddressDetail, "Testcase is fail");
        addNewAddressPage.swipeInHomeAddress();
        addNewAddressPage.clickIconDeleteAnAddress();
        addNewAddressPage.clickAcceptButton();
        softAssert.assertAll();
    ...
    public void verifyAddHomeNewAddressWithNote() {
        ...
        softAssert.assertEquals(actualAddress, expectedAddress, "Testcase is fail");
        softAssert.assertEquals(ADDRESS_NOTE, expectedAddressNote, "Testcase is fail");
        addNewAddressPage.swipeInHomeAddress();
        addNewAddressPage.clickIconDeleteAnAddress();
        addNewAddressPage.clickAcceptButton();
        softAssert.assertAll();
    ...
    public void verifyAddWorkNewAddress() {
        ...
        addNewAddressPage.clickSearchResultMatchAddress0();
        actualAddress = addNewAddressPage.getTextLabelAddress();
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_2, "Testcase is fail");
        addNewAddressPage.clickOnSaveAddressButton();
    ...
    public void verifyAddNewWorkNewAddressWithNote() {
        ...
        addNewAddressPage.clickSearchResultMatchAddress0();
        actualAddress = addNewAddressPage.getTextLabelAddress();
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_2);
        addNewAddressPage.fillAddressNoteField(ADDRESS_NOTE);
        addNewAddressPage.clickOnSaveAddressButton();
        actualAddress = addNewAddressPage.getTextHomeAddressText1();
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_2, "Testcase is fail");
    ...
    public void verifyAddNewOtherNewAddress() {
        ...
        addNewAddressPage.clickSearchResultMatchAddress0();
        actualAddress = addNewAddressPage.getTextLabelAddress();
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_3, "Testcase is fail");
        ...
        softAssert.assertEquals(actualAddress, expectedAddress, "Testcase is fail");
        softAssert.assertEquals(ADDRESS_OTHER_NAME, expectedAddressName, "Testcase is fail");
    ...
    public void verifyAddNewOtherAddressWithDetailAndNote() {
        ...
        addNewAddressPage.clickSearchResultMatchAddress0();
        actualAddress = addNewAddressPage.getTextLabelAddress();
        softAssert.assertEquals(actualAddress, ADDRESS_SEARCH_3);
        addNewAddressPage.fillAddressName(ADDRESS_OTHER_NAME);
        addNewAddressPage.fillInputAddressDetail(ADDRESS_DETAIL);
        addNewAddressPage.fillAddressNoteField(ADDRESS_NOTE);
        addNewAddressPage.clickOnSaveAddressButton();
