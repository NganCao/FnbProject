package com.fnb.app.storeapp.android.linstore.scenationtests.addressmanagement.homepage.delivery.editanddeleteanaddress;
...
public class EditAnAddressScenatioTest extends BaseTest {
    ...
    static String actualAddressName;
...
//        editAnAddressPage.navigateToAddress();
...
//        Assert.assertEquals(addNewAddressPage.verifyTitle(), EDIT_TITLE, "Testcase is fail");
    }
